...
% TODO: Bronnen en introductie schrijven
...
\par For example, information can be retrieved from multiple sources at the same time by means of asynchronous requests, 
...
\par In addition, anonymous functions are often used in combination with higher-order functions.
